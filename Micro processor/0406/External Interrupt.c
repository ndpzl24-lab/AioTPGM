...
typedef struct
               {
                U8 EINT4_FLAG_BIT:1;            // 아들
                U8 EINT5_FLAG_BIT:1;            // 아들
                U8 EINT6_FLAG_BIT:1;            // 아들
                U8 EINT7_FLAG_BIT:1;            // 아들
                U8 TEMP: 4;
               } _BYTE_INT_CHECK;            // 아들

_BYTE_INT_CHECK INT_CHECK_ALL;        // 엄마
...
void main(void){
    ...
    while(1){
        ...
        if(INT_CHECK_ALL.EINT6_FLAG_BIT==1) {
        INT_CHECK_ALL.EINT6_FLAG_BIT=0;
        Random_read();
        PORTC=0xF0;
        }
        if(INT_CHECK_ALL.EINT7_FLAG_BIT==1) {
        INT_CHECK_ALL.EINT7_FLAG_BIT=0;    
        Sequential_read();
        PORTC=0xAA;
        }
    }
...
{
    SREG &= 0x7F;
    INT_CHECK_ALL.EINT7_FLAG_BIT=1;
    SREG |= 0x80;
}
