...
// Create Date: 2026/04/29 10:40:09
...
module clock_counter( resetn, clk, sw, led
    );
    input resetn;
    input clk;
    input [1:0] sw;
    ...
    reg [25:0] cnt0;
    always @(posedge w_clk200 or negedge resetn)
    begin
    ...
    reg [25:0] cnt1;
    always @(posedge w_clk100 or negedge resetn)
    begin
    ...
    reg [25:0] cnt2;
    always @(posedge w_clk50 or negedge resetn)
    begin
    ...
    begin
        if(~resetn) led2 <= 4'b0;
        else        led2 <= (cnt2 == 26'd50_000_000) ? led2 + 1'b1 : led2;
    end
