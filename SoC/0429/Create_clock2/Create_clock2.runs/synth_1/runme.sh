...
HD_PWD='C:/AIOT/SoC/0429/Create_clock2/Create_clock2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_counter.tcl
