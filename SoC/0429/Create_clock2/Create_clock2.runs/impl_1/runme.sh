...
HD_PWD='C:/AIOT/SoC/0429/Create_clock2/Create_clock2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clock_counter.tcl -notrace
