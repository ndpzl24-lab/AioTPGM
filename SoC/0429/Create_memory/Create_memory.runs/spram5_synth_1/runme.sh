...
HD_PWD='C:/AIOT/SoC/0429/Create_memory/Create_memory.runs/spram5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spram5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spram5.tcl
