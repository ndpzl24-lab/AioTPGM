...
HD_PWD='C:/AIOT/SoC/0429/Create_memory/Create_memory.runs/spram6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spram6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spram6.tcl
