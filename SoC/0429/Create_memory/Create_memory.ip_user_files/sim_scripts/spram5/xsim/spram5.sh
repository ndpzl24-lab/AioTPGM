...
#
# Script generated by Vivado on Wed Apr 29 14:20:34 +0900 2026
...
#
# Usage        : spram5.sh
#                spram5.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spram5.sh [-rerun]
#                spram5.sh [-reset_run]
#                spram5.sh [-clean]
#                spram5.sh [-reset_log]
...
# script info
echo -e "spram5.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spram5.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spram5 xil_defaultlib.spram5 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spram5 -key {Behavioral:sim_1:Functional:spram5} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spram5.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spram5.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spram5.sh [-help]\n\
Usage: spram5.sh [-step]\n\
Usage: spram5.sh [-lib_map_path]\n\
Usage: spram5.sh [-rerun]\n\
Usage: spram5.sh [-reset_run]\n\
Usage: spram5.sh [-clean]\n\
Usage: spram5.sh [-reset_log]\n\
Usage: spram5.sh [-keep_index]\n\
Usage: spram5.sh [-noclean_files]\n\n\
