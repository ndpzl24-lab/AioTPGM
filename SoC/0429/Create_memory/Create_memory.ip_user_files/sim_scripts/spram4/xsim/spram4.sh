...
#
# Script generated by Vivado on Wed Apr 29 14:19:52 +0900 2026
...
#
# Usage        : spram4.sh
#                spram4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spram4.sh [-rerun]
#                spram4.sh [-reset_run]
#                spram4.sh [-clean]
#                spram4.sh [-reset_log]
...
# script info
echo -e "spram4.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spram4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spram4 xil_defaultlib.spram4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spram4 -key {Behavioral:sim_1:Functional:spram4} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spram4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spram4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spram4.sh [-help]\n\
Usage: spram4.sh [-step]\n\
Usage: spram4.sh [-lib_map_path]\n\
Usage: spram4.sh [-rerun]\n\
Usage: spram4.sh [-reset_run]\n\
Usage: spram4.sh [-clean]\n\
Usage: spram4.sh [-reset_log]\n\
Usage: spram4.sh [-keep_index]\n\
Usage: spram4.sh [-noclean_files]\n\n\
