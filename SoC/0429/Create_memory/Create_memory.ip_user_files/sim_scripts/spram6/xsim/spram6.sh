...
#
# Script generated by Vivado on Wed Apr 29 14:21:17 +0900 2026
...
# script info
echo -e "spram6.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spram6 xil_defaultlib.spram6 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spram6 -key {Behavioral:sim_1:Functional:spram6} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spram6.wdb xsim.dir libdpi.so)
...
Usage: spram6.sh [-rerun]\n\
Usage: spram6.sh [-reset_run]\n\
Usage: spram6.sh [-clean]\n\
