...
HD_PWD='D:/Verilog/0409/debounced4/debounced4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LedControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LedControl.tcl
