...
HD_PWD='D:/Verilog/0409/debounced4/debounced4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LedControl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LedControl.tcl -notrace
