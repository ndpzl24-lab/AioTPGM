...
HD_PWD='C:/AIOT/Verilog/0417/onecounter5/onecounter5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log onecounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source onecounter.tcl
