...
HD_PWD='C:/AIOT/Verilog/0417/onecounter5/onecounter5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log onecounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source onecounter.tcl -notrace
