...
HD_PWD='C:/AIOT/Verilog/0417/digital_clock/digital_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fnd_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_fnd_control.tcl -notrace
