...
HD_PWD='C:/AIOT/Verilog/0417/digital_clock2/digital_clock2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fndcontrol.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_fndcontrol.tcl
