...
HD_PWD='C:/AIOT/Verilog/0417/digital_clock2/digital_clock2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fndcontrol.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_fndcontrol.tcl -notrace
