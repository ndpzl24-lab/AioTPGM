...
HD_PWD='C:/AIOT/Verilog/0422/stepmotor/stepmotor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stepmotor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stepmotor.tcl
