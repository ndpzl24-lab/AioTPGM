...
HD_PWD='C:/AIOT/Verilog/0422/stepmotor/stepmotor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepmotor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepmotor.tcl -notrace
