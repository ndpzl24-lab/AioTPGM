...
HD_PWD='C:/AIOT/Verilog/0422/dcforrevpwm/dcforrevpwm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dc_motor_l298.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_dc_motor_l298.tcl -notrace
