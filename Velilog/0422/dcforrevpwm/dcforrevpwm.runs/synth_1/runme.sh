...
HD_PWD='C:/AIOT/Verilog/0422/dcforrevpwm/dcforrevpwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dc_motor_l298.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_dc_motor_l298.tcl
