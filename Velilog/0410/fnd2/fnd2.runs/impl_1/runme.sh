...
HD_PWD='D:/Verilog/0410/fnd2/fnd2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fnd2.tcl -notrace
