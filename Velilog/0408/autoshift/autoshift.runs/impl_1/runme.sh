...
HD_PWD='D:/Verilog/0408/autoshift/autoshift.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_led_shift_auto.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_led_shift_auto.tcl -notrace
