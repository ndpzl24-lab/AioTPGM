...
HD_PWD='D:/Verilog/0408/autoshift/autoshift.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_led_shift_auto.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_led_shift_auto.tcl
