...
#
# Script generated by Vivado on Wed Apr 29 15:22:50 +0900 2026
...
#
# Usage        : sdpram2.sh
#                sdpram2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sdpram2.sh [-rerun]
#                sdpram2.sh [-reset_run]
#                sdpram2.sh [-clean]
#                sdpram2.sh [-reset_log]
#                sdpram2.sh [-help]
#
...
# script info
echo -e "sdpram2.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sdpram2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sdpram2 xil_defaultlib.sdpram2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sdpram2 -key {Behavioral:sim_1:Functional:sdpram2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sdpram2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sdpram2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sdpram2.sh [-help]\n\
Usage: sdpram2.sh [-step]\n\
Usage: sdpram2.sh [-lib_map_path]\n\
Usage: sdpram2.sh [-rerun]\n\
Usage: sdpram2.sh [-reset_run]\n\
Usage: sdpram2.sh [-clean]\n\
Usage: sdpram2.sh [-reset_log]\n\
Usage: sdpram2.sh [-keep_index]\n\
Usage: sdpram2.sh [-noclean_files]\n\n\
