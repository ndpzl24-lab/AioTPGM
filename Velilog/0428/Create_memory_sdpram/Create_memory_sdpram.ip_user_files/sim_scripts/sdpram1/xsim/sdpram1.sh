...
#
# Script generated by Vivado on Wed Apr 29 15:22:07 +0900 2026
...
#
# Usage        : sdpram1.sh
#                sdpram1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sdpram1.sh [-rerun]
#                sdpram1.sh [-reset_run]
#                sdpram1.sh [-clean]
#                sdpram1.sh [-reset_log]
#                sdpram1.sh [-help]
#
...
export RDI_DATADIR="C:/AMDDesignTools/2025.2.1/Vivado/data"
...
# script info
echo -e "sdpram1.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sdpram1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sdpram1 xil_defaultlib.sdpram1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sdpram1 -key {Behavioral:sim_1:Functional:sdpram1} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/AMDDesignTools/2025.2.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sdpram1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sdpram1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sdpram1.sh [-help]\n\
Usage: sdpram1.sh [-step]\n\
Usage: sdpram1.sh [-lib_map_path]\n\
Usage: sdpram1.sh [-rerun]\n\
Usage: sdpram1.sh [-reset_run]\n\
Usage: sdpram1.sh [-clean]\n\
Usage: sdpram1.sh [-reset_log]\n\
Usage: sdpram1.sh [-keep_index]\n\
Usage: sdpram1.sh [-noclean_files]\n\n\
