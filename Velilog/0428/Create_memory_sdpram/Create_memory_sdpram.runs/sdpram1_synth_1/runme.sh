...
HD_PWD='C:/AIOT/Verilog/0428/Create_memory_sdpram/Create_memory_sdpram.runs/sdpram1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdpram1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdpram1.tcl
