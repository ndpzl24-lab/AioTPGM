...
HD_PWD='C:/AIOT/Verilog/0428/Create_memory_sdpram/Create_memory_sdpram.runs/sdpram2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdpram2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdpram2.tcl
