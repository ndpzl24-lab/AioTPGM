...
HD_PWD='C:/AIOT/Verilog/0415/sram_test/sram_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sram_test_top.tcl
