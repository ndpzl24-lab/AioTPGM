...
HD_PWD='C:/AIOT/Verilog/0415/sram_test/sram_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sram_test_top.tcl -notrace
