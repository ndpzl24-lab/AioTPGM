...
HD_PWD='D:/Verilog/0415/buttonfnd/buttonfnd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log up_down_fnd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source up_down_fnd.tcl
