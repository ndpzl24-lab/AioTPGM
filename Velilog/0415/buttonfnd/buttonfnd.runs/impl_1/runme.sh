...
HD_PWD='C:/AIOT/Verilog/0415/buttonfnd/buttonfnd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log up_down_fnd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source up_down_fnd.tcl -notrace
