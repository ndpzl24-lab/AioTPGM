...
HD_PWD='C:/AIOT/Verilog/0416/digital_clock/digital_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fnd_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_fnd_control.tcl
